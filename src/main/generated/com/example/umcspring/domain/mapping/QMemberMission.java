...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1659814065L;
    ...
    public final EnumPath<com.example.umcspring.domain.enums.MissionStatus> status = createEnum("status", com.example.umcspring.domain.enums.MissionStatus.class);
