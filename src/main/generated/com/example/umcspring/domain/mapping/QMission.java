...
public class QMission extends EntityPathBase<Mission> {
    ...
    private static final long serialVersionUID = 298370313L;
    ...
    public final com.example.umcspring.domain.QStore store;
    ...
    public QMission(Class<? extends Mission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.store = inits.isInitialized("store") ? new com.example.umcspring.domain.QStore(forProperty("store"), inits.get("store")) : null;
    }
